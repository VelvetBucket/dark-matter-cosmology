    ...
    & vertex)
{
  ...
  TMP2 = (-1.) * (F1[2] * (F2[4] * (V3[2] - V3[5]) + F2[5] * (-V3[3] + cI *
    ...
    & vertex)
{
  ...
  P2[2] = S2[1].imag(); 
  P2[3] = S2[0].imag(); 
  TMP4 = (P1[0] * V3[2] - P1[1] * V3[3] - P1[2] * V3[4] - P1[3] * V3[5]); 
  TMP5 = (P2[0] * V3[2] - P2[1] * V3[3] - P2[2] * V3[4] - P2[3] * V3[5]); 
  vertex = COUP * S1[2] * S2[2] * (-cI * (TMP4) + cI * (TMP5)); 
}
    ...
    std::complex<double> COUP, double M1, double W1, std::complex<double> S1[])
{
  ...
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  S1[2] = denom * S2[2] * (+cI * (TMP4) - cI * (TMP5)); 
}
    ...
    std::complex<double> COUP, double M2, double W2, std::complex<double> S2[])
{
  ...
  denom = COUP/((P2[0] * P2[0]) - (P2[1] * P2[1]) - (P2[2] * P2[2]) - (P2[3] *
      P2[3]) - M2 * (M2 - cI * W2));
  S2[2] = denom * S1[2] * (+cI * (TMP4) - cI * (TMP5)); 
}
    ...
    std::complex<double> COUP, double M3, double W3, std::complex<double> V3[])
{
  ...
  denom = COUP/((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) - (P3[3] *
      P3[3]) - M3 * (M3 - cI * W3));
  V3[2] = denom * S1[2] * S2[2] * (OM3 * P3[0] * (+cI * (TMP6) - cI * (TMP7)) +
      (-cI * (P1[0]) + cI * (P2[0])));
  V3[3] = denom * S1[2] * S2[2] * (OM3 * P3[1] * (+cI * (TMP6) - cI * (TMP7)) +
      (-cI * (P1[1]) + cI * (P2[1])));
  V3[4] = denom * S1[2] * S2[2] * (OM3 * P3[2] * (+cI * (TMP6) - cI * (TMP7)) +
      (-cI * (P1[2]) + cI * (P2[2])));
  V3[5] = denom * S1[2] * S2[2] * (OM3 * P3[3] * (+cI * (TMP6) - cI * (TMP7)) +
      (-cI * (P1[3]) + cI * (P2[3])));
}
    ...
    COUP, std::complex<double> & vertex)
{
  ...
  TMP9 = (V3[2] * V4[2] - V3[3] * V4[3] - V3[4] * V4[4] - V3[5] * V4[5]); 
  vertex = COUP * - cI * TMP9 * S2[2] * S1[2]; 
}
    ...
    & vertex)
{
  ...
  TMP14 = (P3[0] * V2[2] - P3[1] * V2[3] - P3[2] * V2[4] - P3[3] * V2[5]); 
  TMP15 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]); 
  TMP4 = (P1[0] * V3[2] - P1[1] * V3[3] - P1[2] * V3[4] - P1[3] * V3[5]); 
  TMP5 = (P2[0] * V3[2] - P2[1] * V3[3] - P2[2] * V3[4] - P2[3] * V3[5]); 
  TMP8 = (V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5]); 
  vertex = COUP * (TMP12 * (-cI * (TMP13) + cI * (TMP14)) + (TMP15 * (+cI *
      (TMP4) - cI * (TMP5)) + TMP8 * (+cI * (TMP10) - cI * (TMP11))));
}
    ...
    COUP2, std::complex<double> & vertex)
{
  ...
  TMP0 = (F2[4] * F1[4] + F2[5] * F1[5]); 
  TMP3 = (F2[2] * F1[2] + F2[3] * F1[3]); 
  vertex = -S3[2] * (+cI * (TMP0 * COUP1 + TMP3 * COUP2)); 
}
    ...
    W3, std::complex<double> S3[])
{
  ...
  denom = 1./((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) - (P3[3] *
      P3[3]) - M3 * (M3 - cI * W3));
  S3[2] = denom * (+cI * (TMP0 * COUP1 + TMP3 * COUP2)); 
}
