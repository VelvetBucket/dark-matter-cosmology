    ...
    std::complex<double> COUP, double M2, double W2, std::complex<double> F2[])
{
  ...
  F2[4] = denom * cI * S3[2] * (F1[2] * (-P2[0] + P2[3]) + F1[3] * (P2[1] + cI
      * (P2[2])));
    ...
    std::complex<double> COUP, double M1, double W1, std::complex<double> F1[])
{
  ...
  F1[2] = denom * cI * F2[2] * M1 * S3[2]; 
  F1[3] = denom * cI * F2[3] * M1 * S3[2]; 
  F1[4] = denom * cI * S3[2] * (F2[2] * (-P1[0] + P1[3]) + F2[3] * (P1[1] + cI
      * (P1[2])));
    ...
    & vertex)
{
  ...
  P2[2] = S2[1].imag(); 
  P2[3] = S2[0].imag(); 
  TMP2 = (P1[0] * V3[2] - P1[1] * V3[3] - P1[2] * V3[4] - P1[3] * V3[5]); 
  TMP3 = (P2[0] * V3[2] - P2[1] * V3[3] - P2[2] * V3[4] - P2[3] * V3[5]); 
  vertex = COUP * S1[2] * S2[2] * (-cI * (TMP2) + cI * (TMP3)); 
}
    ...
    std::complex<double> COUP, double M1, double W1, std::complex<double> S1[])
{
  ...
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  S1[2] = denom * S2[2] * (+cI * (TMP2) - cI * (TMP3)); 
}
    ...
    std::complex<double> COUP, double M2, double W2, std::complex<double> S2[])
{
  ...
  denom = COUP/((P2[0] * P2[0]) - (P2[1] * P2[1]) - (P2[2] * P2[2]) - (P2[3] *
      P2[3]) - M2 * (M2 - cI * W2));
  S2[2] = denom * S1[2] * (+cI * (TMP2) - cI * (TMP3)); 
}
    ...
    std::complex<double> COUP, double M3, double W3, std::complex<double> V3[])
{
  ...
  denom = COUP/((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) - (P3[3] *
      P3[3]) - M3 * (M3 - cI * W3));
  V3[2] = denom * S1[2] * S2[2] * (-cI * (P1[0]) + cI * (P2[0])); 
  V3[3] = denom * S1[2] * S2[2] * (-cI * (P1[1]) + cI * (P2[1])); 
  V3[4] = denom * S1[2] * S2[2] * (-cI * (P1[2]) + cI * (P2[2])); 
  V3[5] = denom * S1[2] * S2[2] * (-cI * (P1[3]) + cI * (P2[3])); 
}
    ...
    std::complex<double> COUP, double M3, double W3, std::complex<double> V3[])
{
  ...
  denom = COUP/((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) - (P3[3] *
      P3[3]) - M3 * (M3 - cI * W3));
  V3[2] = denom * S1[2] * S2[2] * (OM3 * P3[0] * (+cI * (TMP4) - cI * (TMP5)) +
      (-cI * (P1[0]) + cI * (P2[0])));
  V3[3] = denom * S1[2] * S2[2] * (OM3 * P3[1] * (+cI * (TMP4) - cI * (TMP5)) +
      (-cI * (P1[1]) + cI * (P2[1])));
  V3[4] = denom * S1[2] * S2[2] * (OM3 * P3[2] * (+cI * (TMP4) - cI * (TMP5)) +
      (-cI * (P1[2]) + cI * (P2[2])));
  V3[5] = denom * S1[2] * S2[2] * (OM3 * P3[3] * (+cI * (TMP4) - cI * (TMP5)) +
      (-cI * (P1[3]) + cI * (P2[3])));
}
    ...
    & vertex)
{
  ...
  TMP6 = (-1.) * (F1[2] * (F2[4] * (V3[2] - V3[5]) + F2[5] * (-V3[3] + cI *
      (V3[4]))) + F1[3] * (F2[4] * (-1.) * (V3[3] + cI * (V3[4])) + F2[5] *
      (V3[2] + V3[5])));
  vertex = COUP * - cI * TMP6; 
}
    ...
    & vertex)
{
  ...
  TMP11 = (P1[0] * V2[2] - P1[1] * V2[3] - P1[2] * V2[4] - P1[3] * V2[5]); 
  TMP12 = (V3[2] * V1[2] - V3[3] * V1[3] - V3[4] * V1[4] - V3[5] * V1[5]); 
  TMP13 = (P3[0] * V2[2] - P3[1] * V2[3] - P3[2] * V2[4] - P3[3] * V2[5]); 
  TMP14 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]); 
  TMP2 = (P1[0] * V3[2] - P1[1] * V3[3] - P1[2] * V3[4] - P1[3] * V3[5]); 
  TMP3 = (P2[0] * V3[2] - P2[1] * V3[3] - P2[2] * V3[4] - P2[3] * V3[5]); 
  TMP8 = (V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5]); 
  TMP9 = (P2[0] * V1[2] - P2[1] * V1[3] - P2[2] * V1[4] - P2[3] * V1[5]); 
  vertex = COUP * (TMP12 * (-cI * (TMP11) + cI * (TMP13)) + (TMP14 * (+cI *
      (TMP2) - cI * (TMP3)) + TMP8 * (+cI * (TMP9) - cI * (TMP10))));
}
    ...
    COUP, std::complex<double> & vertex)
{
  ...
  TMP16 = (V3[2] * V4[2] - V3[3] * V4[3] - V3[4] * V4[4] - V3[5] * V4[5]); 
  vertex = COUP * - cI * TMP16 * S2[2] * S1[2]; 
}
    ...
    COUP2, std::complex<double> & vertex)
{
  ...
  TMP0 = (F2[4] * F1[4] + F2[5] * F1[5]); 
  TMP1 = (F2[2] * F1[2] + F2[3] * F1[3]); 
  vertex = -S3[2] * (+cI * (TMP0 * COUP1 + TMP1 * COUP2)); 
}
    ...
    W2, std::complex<double> F2[])
{
  ...
  P2[2] = -F2[1].imag(); 
  P2[3] = -F2[0].imag(); 
  denom = 1./((P2[0] * P2[0]) - (P2[1] * P2[1]) - (P2[2] * P2[2]) - (P2[3] *
      P2[3]) - M2 * (M2 - cI * W2));
  F2[2] = denom * - cI * S3[2] * (COUP1 * (F1[4] * (P2[0] + P2[3]) + F1[5] *
      (P2[1] + cI * (P2[2]))) - F1[2] * M2 * COUP2);
  F2[3] = denom * cI * S3[2] * (COUP1 * (F1[4] * (-P2[1] + cI * (P2[2])) +
      F1[5] * (-P2[0] + P2[3])) + F1[3] * M2 * COUP2);
  F2[4] = denom * cI * S3[2] * (COUP2 * (F1[2] * (-P2[0] + P2[3]) + F1[3] *
      (P2[1] + cI * (P2[2]))) + F1[4] * M2 * COUP1);
  F2[5] = denom * - cI * S3[2] * (COUP2 * (F1[2] * (-P2[1] + cI * (P2[2])) +
      F1[3] * (P2[0] + P2[3])) - F1[5] * M2 * COUP1);
}
    ...
    W1, std::complex<double> F1[])
{
  ...
  P1[2] = -F1[1].imag(); 
  P1[3] = -F1[0].imag(); 
  denom = 1./((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  F1[2] = denom * cI * S3[2] * (COUP1 * (F2[4] * (P1[0] - P1[3]) + F2[5] *
      (-P1[1] + cI * (P1[2]))) + F2[2] * M1 * COUP2);
  F1[3] = denom * - cI * S3[2] * (COUP1 * (F2[4] * (P1[1] + cI * (P1[2])) -
      F2[5] * (P1[0] + P1[3])) - F2[3] * M1 * COUP2);
  F1[4] = denom * - cI * S3[2] * (COUP2 * (F2[2] * (-1.) * (P1[0] + P1[3]) +
      F2[3] * (-P1[1] + cI * (P1[2]))) - F2[4] * M1 * COUP1);
  F1[5] = denom * cI * S3[2] * (COUP2 * (F2[2] * (P1[1] + cI * (P1[2])) + F2[3]
      * (P1[0] - P1[3])) + F2[5] * M1 * COUP1);
}
    ...
    W1, std::complex<double> F1[])
{
  ...
  F1[3] = denom * cI * S3[2] * (COUP1 * (F2[4] * (-P1[1] + cI * (P1[2])) +
      F2[5] * (-P1[0] + P1[3])) + F2[3] * M1 * COUP2);
  F1[4] = denom * cI * S3[2] * (COUP2 * (F2[2] * (-P1[0] + P1[3]) + F2[3] *
      (P1[1] + cI * (P1[2]))) + F2[4] * M1 * COUP1);
  F1[5] = denom * - cI * S3[2] * (COUP2 * (F2[2] * (-P1[1] + cI * (P1[2])) +
      F2[3] * (P1[0] + P1[3])) - F2[5] * M1 * COUP1);
}
    ...
    W2, std::complex<double> F2[])
{
  ...
  F2[3] = denom * - cI * S3[2] * (COUP1 * (F1[4] * (P2[1] + cI * (P2[2])) -
      F1[5] * (P2[0] + P2[3])) - F1[3] * M2 * COUP2);
  F2[4] = denom * - cI * S3[2] * (COUP2 * (F1[2] * (-1.) * (P2[0] + P2[3]) +
      F1[3] * (-P2[1] + cI * (P2[2]))) - F1[4] * M2 * COUP1);
  F2[5] = denom * cI * S3[2] * (COUP2 * (F1[2] * (P2[1] + cI * (P2[2])) + F1[3]
      * (P2[0] - P2[3])) + F1[5] * M2 * COUP1);
}
    ...
    W3, std::complex<double> S3[])
{
  ...
  denom = 1./((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) - (P3[3] *
      P3[3]) - M3 * (M3 - cI * W3));
  S3[2] = denom * (+cI * (TMP0 * COUP1 + TMP1 * COUP2)); 
}
    ...
    COUP2, std::complex<double> & vertex)
{
  ...
  TMP17 = (F1[4] * (F2[2] * (V3[2] - V3[5]) - F2[3] * (V3[3] + cI * (V3[4]))) +
      F1[5] * (F2[2] * (-V3[3] + cI * (V3[4])) + F2[3] * (V3[2] + V3[5])));
  TMP18 = (F1[2] * (F2[4] * (V3[2] + V3[5]) + F2[5] * (V3[3] + cI * (V3[4]))) +
      F1[3] * (F2[4] * (V3[3] - cI * (V3[4])) + F2[5] * (V3[2] - V3[5])));
  vertex = (-1.) * (+cI * (COUP1 * TMP17 + COUP2 * TMP18)); 
}


}  // end namespace $(namespace)s_scotogenic_UFO
