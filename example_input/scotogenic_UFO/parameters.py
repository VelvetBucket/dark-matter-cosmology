...
WetI = Parameter(name = 'WetI',
    ...
    type = 'real',
    value = 0.,
    texname = '\\Gamma_{\\eta_I}',
    lhablock = 'DECAY',
    lhacode = [1002])

MetR = Parameter(name = 'MetR',
    nature = 'external',
    type = 'real',
    value = 100.,
    texname = 'M_{\\eta_R}',
...
WetR = Parameter(name = 'WetR',
    nature = 'external',
    type = 'real',
    value = 0.,
    texname = '\\Gamma_{\\eta_R}',
    lhablock = 'DECAY',
    lhacode = [1001])
...
Yn11 = Parameter(name='Yn11',
    nature = 'internal',
    type = 'complex',
    value = 'rYn11 + complex(0,1)*iYn11',
    texname = '\\text{Yn11}' )

Yn12 = Parameter(name='Yn12',
    nature = 'internal',
    type = 'complex',
    value = 'rYn12 + complex(0,1)*iYn12',
    texname = '\\text{Yn12}' )

Yn13 = Parameter(name='Yn13',
    nature = 'internal',
    type = 'complex',
    value = 'rYn13 + complex(0,1)*iYn13',
    texname = '\\text{Yn13}' )

Yn21 = Parameter(name='Yn21',
    nature = 'internal',
    type = 'complex',
    value = 'rYn21 + complex(0,1)*iYn21',
    texname = '\\text{Yn21}' )

Yn22 = Parameter(name='Yn22',
    nature = 'internal',
    type = 'complex',
    value = 'rYn22 + complex(0,1)*iYn22',
    texname = '\\text{Yn22}' )

Yn23 = Parameter(name='Yn23',
    nature = 'internal',
    type = 'complex',
    value = 'rYn23 + complex(0,1)*iYn23',
    texname = '\\text{Yn23}' )

Yn31 = Parameter(name='Yn31',
    nature = 'internal',
    type = 'complex',
    value = 'rYn31 + complex(0,1)*iYn31',
    texname = '\\text{Yn31}' )

Yn32 = Parameter(name='Yn32',
    nature = 'internal',
    type = 'complex',
    value = 'rYn32 + complex(0,1)*iYn32',
    texname = '\\text{Yn32}' )

Yn33 = Parameter(name='Yn33',
    nature = 'internal',
    type = 'complex',
    value = 'rYn33 + complex(0,1)*iYn33',
    texname = '\\text{Yn33}' )
...
ZX11 = Parameter(name='ZX11',
    nature = 'internal',
    type = 'complex',
    value = 'rZX11 + complex(0,1)*iZX11',
    texname = '\\text{ZX11}' )

ZX12 = Parameter(name='ZX12',
    nature = 'internal',
    type = 'complex',
    value = 'rZX12 + complex(0,1)*iZX12',
    texname = '\\text{ZX12}' )

ZX13 = Parameter(name='ZX13',
    nature = 'internal',
    type = 'complex',
    value = 'rZX13 + complex(0,1)*iZX13',
    texname = '\\text{ZX13}' )

ZX21 = Parameter(name='ZX21',
    nature = 'internal',
    type = 'complex',
    value = 'rZX21 + complex(0,1)*iZX21',
    texname = '\\text{ZX21}' )

ZX22 = Parameter(name='ZX22',
    nature = 'internal',
    type = 'complex',
    value = 'rZX22 + complex(0,1)*iZX22',
    texname = '\\text{ZX22}' )

ZX23 = Parameter(name='ZX23',
    nature = 'internal',
    type = 'complex',
    value = 'rZX23 + complex(0,1)*iZX23',
    texname = '\\text{ZX23}' )

ZX31 = Parameter(name='ZX31',
    nature = 'internal',
    type = 'complex',
    value = 'rZX31 + complex(0,1)*iZX31',
    texname = '\\text{ZX31}' )

ZX32 = Parameter(name='ZX32',
    nature = 'internal',
    type = 'complex',
    value = 'rZX32 + complex(0,1)*iZX32',
    texname = '\\text{ZX32}' )

ZX33 = Parameter(name='ZX33',
    nature = 'internal',
    type = 'complex',
    value = 'rZX33 + complex(0,1)*iZX33',
    texname = '\\text{ZX33}' )
